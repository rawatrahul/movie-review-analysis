...
## Constants
CODE_DIRECTORY = 'sentiment_analyser'
DOCS_DIRECTORY = 'docs'
...
#
#     from sentiment_analyser import metadata
#
# However, when we do this, we also import `sentiment_analyser/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'sentiment_analyser_cli = sentiment_analyser.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'sentiment_analyser_gui = sentiment_analyser.gui:entry_point'
        # ]
    }
)
